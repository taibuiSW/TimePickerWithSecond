...
import com.funix.prm391x.se00255x.timepickerwithsecond.TimePicker.OnTimeChangedListener;
...
public class TimePickerDialog extends AlertDialog implements OnClickListener,
    ...
    public TimePickerDialog(Context context,
        ...
        setButton(Dialog.BUTTON_POSITIVE, context.getText(R.string.time_set), this);
        setButton(Dialog.BUTTON_NEUTRAL, context.getText(R.string.cancel), (OnClickListener) null);
    ...
    public void updateTime(int hourOfDay, int minute, int seconds) {
